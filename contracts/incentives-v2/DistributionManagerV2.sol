...
contract DistributionManagerV2 is IAaveDistributionManagerV2 {
   ...
   * @param totalStaked Current total of staked _assets for this distribution
  ...
  function _updateUserRewardsInternal(
    ...
    uint256 newIndex = _updateAssetStateInternal(asset, reward, rewardData, totalStaked);
  ...
  function _getUnrealizedRewardsFromStake(
    ...
    return _getRewards(stake.stakedByUser, assetIndex, rewardData.usersIndex[user]);
  }
