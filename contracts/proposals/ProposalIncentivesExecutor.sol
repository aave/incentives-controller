...
contract ProposalIncentivesExecutor is IProposalIncentivesExecutor {
  ...
  //TODO: deploy and set a proper implementation of the incentives controller
  address constant INCENTIVES_CONTROLLER_IMPL_ADDRESS = 0xd784927Ff2f95ba542BfC824c8a8a98F3495f6b5;
  ...
  function execute(
    ...
    // Reserves Order: DAI/USDC/USDT/GUSD/WBTC/WETH
    ...
    emissions[2] = 5291203703703700; //aUSDC
    emissions[3] = 5291203703703700; //vDebtUSDC
    emissions[4] = 3293634259259260; //aUSDT
    emissions[5] = 3293634259259260; //vDebtUSDT
    emissions[6] =   92939814814815; //aGUSD
    emissions[7] =   92939814814815; //vDebtGUSD
